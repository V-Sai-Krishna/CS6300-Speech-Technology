...
np.savetxt(file1,hmm_1.pi_states)
file1=newpath+"/A.txt"
np.savetxt(file1,hmm_1.A)
file1=newpath+"/B.txt"
np.savetxt(file1,hmm_1.B)
################ DIGIT 2 ################
...
if not os.path.exists(newpath):
	os.makedirs(newpath)
file1=newpath+"/pi.txt"
np.savetxt(file1,hmm_2.pi_states)
file1=newpath+"/A.txt"
np.savetxt(file1,hmm_2.A)
file1=newpath+"/B.txt"
np.savetxt(file1,hmm_2.B)
############ DIGIT 8 ####################
...
if not os.path.exists(newpath):
	os.makedirs(newpath)
file1=newpath+"/pi.txt"
np.savetxt(file1,hmm_8.pi_states)
file1=newpath+"/A.txt"
np.savetxt(file1,hmm_8.A)
file1=newpath+"/B.txt"
np.savetxt(file1,hmm_8.B)
...
if not os.path.exists(newpath):
	os.makedirs(newpath)
file1=newpath+"/pi.txt"
np.savetxt(file1,hmm_o.pi_states)
file1=newpath+"/A.txt"
np.savetxt(file1,hmm_o.A)
file1=newpath+"/B.txt"
np.savetxt(file1,hmm_o.B)
################## DIGIT Z #####################
...
if not os.path.exists(newpath):
	os.makedirs(newpath)
file1=newpath+"/pi.txt"
np.savetxt(file1,hmm_z.pi_states)
file1=newpath+"/A.txt"
np.savetxt(file1,hmm_z.A)
file1=newpath+"/B.txt"
np.savetxt(file1,hmm_z.B)
####################### TEST ######################
